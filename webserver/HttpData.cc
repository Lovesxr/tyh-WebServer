...
void HttpData::setHolder(std::shared_ptr<TcpConnection> holder)
{
    holder_ = holder;
...
void HttpData::onRequest(Buffer *input)
{
    ...
    if (path_ == "/")
    {
        ...
        addARepHeader("Server", "tyh's Web Server");
    ...
    else if (path_ == "/favicon.ico")
    {
        ...
        //addARepHeader("Server","tyh's Web Server")
        //addARepHeader("Content-Length:",to_string(sizeof HttpData::favicon));
